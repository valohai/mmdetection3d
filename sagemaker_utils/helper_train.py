...
LOCAL_SCRIPTS_DIR = "sagemaker_utils"
...
estimator = PyTorch(
    entry_point="mvxnet_train.py",  # This file must be inside source_dir
    source_dir=LOCAL_SCRIPTS_DIR,  # Local directory where the script is stored
    role=iam_role,
    instance_count=1,
